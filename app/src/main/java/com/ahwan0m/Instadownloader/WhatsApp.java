                    ...
                    new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                vidOptions.add("Lihat");
                                vidOptions.add("Simpan");
                                vidOptions.add("Bagikan");
                                AlertDialog.Builder alertDialog = new AlertDialog.Builder(WhatsApp.this);
                                alertDialog.setTitle("Pilih Tindakan");
                                ...
                                alertDialog.setAdapter(optionsAdapter, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int pos) {
                                            ...
                                            {
                                                try {
                                                    copyFile(fileList.get(i), new File(Environment.getExternalStorageDirectory().toString() + "/MediaDownloader/" + fileList.get(i).getName()));
                                                } catch (IOException e) {
                                                    e.printStackTrace();
                                                }
                                                StyleableToast.makeText(getBaseContext(), "Berhasil disimpan", Toast.LENGTH_SHORT, R.style.wapptoast).show();
                                            }
                                            else if(pos==2)
                                            {
                                ...
                                e.printStackTrace();
                                StyleableToast.makeText(getBaseContext(), "Sepertinya Ada masalah :(", Toast.LENGTH_SHORT, R.style.wapptoast).show();
                            }
                        }
                    }.run();
                }
